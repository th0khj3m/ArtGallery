...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250205021116_RolesAdded")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "87beaa8e-5a4e-43dc-9739-1d810173e96f",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "5365dfca-5f0b-4d3b-859a-2ef2a19bb03a",
                            Name = "Customer",
            ...
            modelBuilder.Entity("Core.Entities.OrderAggregate.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Core.Entities.OrderAggregate.ArtworkItemOrdered", "ItemOrdered", b1 =>
                        {
                            b1.Property<int>("OrderItemId")
                                .HasColumnType("int");

                            b1.Property<int>("ArtworkId")
                                .HasColumnType("int");

                            b1.Property<string>("ArtworkTitle")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
